describe('Basic user flow for Website', () => {
  ...
  it('Checking number of items in cart on screen', async () => {
    ...
    const itext = await cartcount.getProperty('innerText');
    const value = await itext.jsonValue();
  ...
  it('Checking the localStorage to make sure cart is correct', async () => {
    ...
    var value = await page.evaluate(()=>{return localStorage.getItem('cart')});
  ...
  it('Checking the localStorage to make sure cart is correct', async () => {
    ...
    //var value = await page.evaluate(()=>{window.localStorage.getItem('cart')});
    var value = await page.evaluate(()=>{return localStorage.getItem('cart')});
    expect(value).toBe('[]');
  });
